<h2 align="left">
  <div>
   ...
   <br> I'm Solaiman Aghribi, Aspiring Web Developer & Software Engineer :computer:<br>
   <br>
<img src="https://media.giphy.com/media/unQ3IJU2RG7PEvO0yH/giphy.gif" alt="Fluent Coding" width="500">  </div>
</h2> 
...
- :computer: Final-year Computer Science student based in Tangier, Morocco.
- :hourglass_flowing_sand: Currently building a Hospital Management System (C# Desktop & Laravel Web) for my PFE, due July 2026.
- :rocket: Exploring AI engineering and integrating APIs (Gemini, Claude) into my projects.
- :man_technologist: Digital Content Creator managing multiple platforms, including a YouTube channel with over 6K subscribers.
- :dart: Currently completing the Scrimba Fullstack Developer path and building responsive portfolio projects with Vanilla HTML, CSS, and JS.
- 🌱 **Current Focus:** Deepening my knowledge in React and Laravel to build robust web applications.
